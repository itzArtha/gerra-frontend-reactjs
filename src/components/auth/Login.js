    ...
    return (
        <Layout>
            <React.Fragment>
                ...
                <div className={["/user/login", "/organization/login"].includes(path) ? `pt-20 md:pt-36` : ``}>
                    <div
                        className={["/user/login", "/organization/login"].includes(path) ? `flex max-w-sm mx-auto overflow-hidden bg-white rounded-lg lg:shadow-lg dark:bg-gray-800 lg:max-w-1/2` : ``}>
                            ...
                            <form onSubmit={handleSubmit} method="post">
                                ...
                                <div className="mt-8 grid grid-cols-2 gap-2">
                                    <SecBtn
                                        ...
                                        disabled={isLoading}
                                        onClick={() => {
                                            ["/user/login", "/organization/login"].includes(path) ? history.push( "/login") : callback("")
                                        }}
                                    />
                                    <MainBtn
                                        type="submit"
