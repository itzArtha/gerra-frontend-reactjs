  ...
  return (
    <div className="h-24 p-2 md:mb-20 mb-12 fixed w-full z-10 bottom-0 flex justify-center">
      ...
      <div title="Scan" className="text-center cursor-pointer md:mx-2 mx-1">
        <Link to="/">
          <div className="shadow-lg rounded-full bg-yellow-400 duration-200 transform hover:bg-yellow-300 md:p-6 p-3 md:h-24 md:w-24 h-16 w-16 md:mx-2 mx-1 border-black border-2">
            <img
              className="w-18 h-18"
