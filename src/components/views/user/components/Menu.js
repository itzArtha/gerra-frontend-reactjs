        ...
        <>
            {
                showScanner
                    ?
                    <InfoModal title={`Scan QR Code`} handleClose={() => {
            ...
            <div className="h-24 p-2 md:mb-20 mb-12 fixed w-full z-10 bottom-0 flex justify-center">
                <div title="Home" className="text-center cursor-pointer md:mx-2 mx-1">
                    <Link to="/">
                        <div
                            className="shadow-lg rounded-full bg-yellow-400 duration-200 transform hover:bg-yellow-300 md:pl-4 md:pr-4 md:pt-3 px-2 h-12 w-12 md:h-20 md:w-20 md:mx-2 mx-1 border-black border-2">
                            <img
                                className="w-12 h-12"
                        ...
                        <div
                            className="rounded-full shadow-lg bg-yellow-400 duration-200 transform hover:bg-yellow-300 md:py-1 px-2 mt-2 border-black border">
                            <span className="md:text-sm text-xs font-semibold">Home</span>
                        </div>
                    </Link>
                </div>
                <div title="Explore" className="text-center cursor-pointer md:mx-2 mx-1">
                    <Link to="/explore/event">
                        <div
                            className="shadow-lg rounded-full bg-yellow-400 duration-200 transform hover:bg-yellow-300 md:p-4 pb-4 px-2 h-12 w-12 md:h-20 md:w-20  md:mx-2 mx-1 border-black border-2">
                            <img
                                className="w-12 h-12"
                        ...
                        <div
                            className="shadow-lg rounded-full bg-yellow-400 duration-200 transform hover:bg-yellow-300 md:py-1 px-2 mt-2 border-black border">
                ...
                <div title="Notif" className="text-center cursor-pointer md:mx-2 mx-1">
                    <Link to="/notifications/announcements">
                        <div
                            ...
                            />
                            <div
                                className="top-0 right-0 md:h-8 md:w-8 w-6 h-6 align-top bg-purple-500 rounded-full border border-black absolute">
